...
const multerProduct_1 = require("../../middleware/multerProduct");
...
router.post('/', multerProduct_1.multerProduct.single('image'), product_controller_1.productController.createProduct);
